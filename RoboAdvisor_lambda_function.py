...
### Validation ###
def validation(age, investment_amount, intent_request):
#Age Validation
    if age is not None:
        age = int(age)
        if age >= 65:
            return build_validation_result(
                False,
                "age",
                "You should be under 65 to use this service, please provide a different date of birth.",
            )
        elif age < 18:
            return build_validation_result(
                False,
                "age",
                "You are too young to invest, go ask your parents consent.Kindly provide a valid age.",
            )
    ...
    if investment_amount is not None:
        ...
        if investment_amount < 5000:
            return build_validation_result(
                False,
                "investmentAmount",
                "The minimum investment amount is US$5,000.",
            )
...
def recommend_portfolio(intent_request):
    ...
    if source == "DialogCodeHook":
        ...
        validation_result = validation(age, investment_amount, intent_request)
